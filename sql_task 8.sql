...
select * from sales where customer_id ~* 'cg'
...
select customer_id, product_id,sales::varchar from sales where sales::varchar ~* '[5-9](2|4|6){2}.[0-9]6'
...
select customer_id,postal_code::varchar from customer where postal_code::varchar ~* '(1|2|3|4)[0-9]{2}(1|2|3|8|9)[0-9]'

select customer_id,customer_name,age from customer where customer_id ~* 'gh-[0-9]{5}' or customer_id ~* 'sh-[0-9]{5}'
